...
<html lang="ko">
    <head>
        ...
        <link href="${pageContext.request.contextPath}/resources/css/8.freeBoard.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <main>
            ...
            <div id="main_middle">
                ...
                <hr>
                <div class="search">
                    <form action="/board/freeBoardSearch.do" method="get">
	                ...
	                <button class="insertBoard" onclick="javascript: location.href='/board/insert.do'" style="margin-top:-10px; padding:0px 10px; margin-left:10px;">글 쓰기</button>
	                </c:if>
                </div>
                <table>
                    <thead>
